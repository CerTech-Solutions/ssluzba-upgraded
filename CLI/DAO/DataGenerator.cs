...
public class DataGenerator
{
    public static void Generate()
    {
        ...
        Profesor p0 = new Profesor(0, "Veljko", "Petrovic", DateOnly.Parse("2/2/1982"), a0, "021/485-4564", "pveljko@uns.ac.rs", "123456789", "doc.", 10);
        Profesor p1 = new Profesor(1, "Milan", "Rapajic", DateOnly.Parse("2/2/1982"), a0, "021/485-4584", "rapaja@uns.ac.rs", "123456789", "prof.", 20);
        Profesor p2 = new Profesor(2, "Vladimir", "Dimitrieski", DateOnly.Parse("2/2/1982"), a1, "021/485-2424", "dimi@uns.ac.rs", "123456789", "prof.", 15);
        ...
        Student s0 = new Student(0, "Nikola", "Kuslakovic", DateOnly.Parse("2/2/2002"), a2, "123456789", "kuslakovic.ra8.2021@uns.ac.rs", 3, StatusEnum.B, 10.0, new Indeks("RA", 8, 2021));
        Student s1 = new Student(1, "Nemanja", "Zekanovic", DateOnly.Parse("2/2/2002"), a3, "123456789", "zekanovic.ra73.2021@uns.ac.rs", 3, StatusEnum.S, 8.0, new Indeks("RA", 73, 2021));
        ...
        Ocena o0 = new Ocena(0, s1, pr3, 6, DateOnly.Parse("2/2/2002"));
        Ocena o1 = new Ocena(1, s1, pr0, 10, DateOnly.Parse("2/2/2002"));
        Ocena o2 = new Ocena(2, s0, pr2, 10, DateOnly.Parse("2/2/2002"));
